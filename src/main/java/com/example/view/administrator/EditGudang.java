 ...
 * @author riel
 */
public class EditGudang extends javax.swing.JFrame {

    private Inventory remote = null;
    private final Vector dataGudang;

    public EditGudang(Inventory remote, Vector dataGudang) {
        initComponents();
        this.remote = remote;
        this.dataGudang = dataGudang;
        idField.disable();
        idField.setText(dataGudang.get(0).toString());
        namaField.setText(dataGudang.get(1).toString());
        alamatField.setText(dataGudang.get(2).toString());
    }
    ...
    private void simpanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanBtnActionPerformed
        ...
        if (answer == 0) {
            Gudang gudang = new Gudang(dataGudang.get(0).toString(),
                    namaField.getText(),
                    alamatField.getText()
            );
            try {
                ...
                Logger.getLogger(EditGudang.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditGudang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new EditGudang().setVisible(true);
            }
        });
    }
